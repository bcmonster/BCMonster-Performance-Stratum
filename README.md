...
{
  "dependencies": {
    "stratum-pool": "git+https://github.com/bcmonster/Stratum-Pool-BCMonster.git"
  }
}
```
...
2. Click "Fork"
3. Rename your fork to `Stratum-Pool-BCMonster`
4. Clone it locally:
   ```bash
   git clone https://github.com/YOUR-USERNAME/Stratum-Pool-BCMonster.git
   cd Stratum-Pool-BCMonster
...
# Push to your repo
git remote set-url origin https://github.com/bcmonster/Stratum-Pool-BCMonster.git
